...
REM 启动 SSH Log MCP 服务
echo [7/8] 启动 SSH Log MCP 服务...
start "SSH Log MCP Server" /min %PYTHON_CMD% mcp_servers/ssh_log_server.py
timeout /t 2 /nobreak >nul
echo [成功] SSH Log MCP 服务已启动
echo.
...
echo   - SSH Log: type mcp_ssh_log.log
